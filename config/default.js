...
module.exports = {
  ...
  GRAPH_DB_URI:
    ...
    "bolt://localhost:7687",
  GRAPH_DB_USER:
    process.env.GRAPH_DB_USER || process.env.GRAPHENEDB_BOLT_USER || "neo4j",
  GRAPH_DB_PASSWORD:
  ...
  AUTH0_CLIENT_ID:
    process.env.AUTH0_CLIENT_ID || "e6oZAxnoFvjdRtjJs1Jt3tquLnNXXXXX",
  AUTH0_CLIENT_SECRET:
    process.env.AUTH0_CLIENT_SECRET ||
    "OGCzOnQkhYTQpZM3NI0sD--JJ_EPcm2E7707_k6zX11m223LrRK1-QZL4PoXXXXX",
