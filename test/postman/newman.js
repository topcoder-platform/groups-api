 ...
 */
 async function clearTestData () {
  ...
  await helper.postRequest(`${config.HOST}/groups/internal/jobs/clean`)
 ...
 */
apiTestLib.runTests(requests, require.resolve('./groups-api.postman_collection.json'),
                      require.resolve('./groups-api.postman_environment.json')).then(async () => {
